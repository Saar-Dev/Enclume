...
| `PLANS/PLAN_BLOCAGE_CASES_OCCUPEES.md` | Empêcher de poser un token sur une case déjà occupée — `canOccupy` n'intervient qu'au déplacement, jamais à la pose initiale | Stub 2026-09-17, cadrage détaillé non commencé — décision produit à trancher avec Saar avant tout code |
