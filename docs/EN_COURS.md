...
| **SALLENIV1** | World builder : sol d'une salle rendu systématiquement à y=0 quel que soit son étage réel (`SurfaceDungeonScene.jsx` `RoomSlab` — piège `Number(null)===0`). Corrigé, tests + build OK, détail `docs/BUGIDENTIFIE.md` | En attente de validation en jeu par Saar |
