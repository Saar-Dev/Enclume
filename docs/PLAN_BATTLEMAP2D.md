...
| 4 | **Non commencé** — sélecteur de cartes façon Roll20 (deux panneaux, vignettes) + arborescence dossiers + icône 2D/3D | Lot 3 | UI revue le 2026-07-28 (référence Roll20 partagée par Saar), remplace le popover initialement prévu — migration **213** |
