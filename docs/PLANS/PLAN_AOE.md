...
> Version 8 — 2026-08-27 (Claude/Saar). **Statut : implémentation en cours.** §12 (État
> d'implémentation, en pied de document) tient la liste vivante de ce qui est codé/testé/en attente —
> ne pas laisser diverger, c'est la source de vérité de l'avancement réel, pas cette bannière.
>
