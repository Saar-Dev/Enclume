...
| Drones — Télépilotage (Sprint 3) | `PLANS/PLAN_DRONE.md` | Fiche drone + combat manuel (Sprint 1/1bis/2a/2b/2c) **clos et vérifiés en code**. **Sprint 2d (mode autonome « ordres permanents ») CLOS, confirmé fonctionnel en jeu réel le 2026-09-18** — détail durable `docs/SYSTEME/COMBAT.md` § « Mode autonome drone ». Seul reste réel : Sprint 3 (télépilotage — rien codé, compétence `TELEPILOTAGE` déjà au catalogue) |
