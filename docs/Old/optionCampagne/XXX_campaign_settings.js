// server/src/db/migrations/XXX_campaign_settings.js

export const up = async (knex) => {
  // Supprimer la table morte campaign_rules
  await knex.schema.dropTableIfExists('campaign_rules')

  // Créer la colonne settings
...
export const down = async (knex) => {
  ...
  // Restaurer les données depuis settings
