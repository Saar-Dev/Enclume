...
> Ce contrat s'applique à Kiwi et à Saar après validation et installation dans le dépôt. Saar
> travaille avec deux assistants distincts (Claude et GPT/Codex) — chacun écrit sur sa propre
> branche pour ne jamais se marcher dessus (voir § 3).
...
| Saar — GPT/Codex | `dev/monde` | `/home/codex/Enclume-integrated` | `8293/8294` |
| Saar — Claude | `dev/Saar` | worktree local (Windows), pas de serveur dédié | — |
| Validation commune | `integration` | `/home/codex/Enclume-fusion` | `8393/8394` |

- Claude et GPT/Codex sont deux assistants distincts utilisés par Saar — jamais la même
  branche, pour éviter qu'ils s'écrasent mutuellement sans coordination.
