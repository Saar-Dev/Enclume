...
// affichage). Partagé par ChancePlayerChoiceCard.jsx et CatastropheChoiceQueue.jsx, même calcul
// (rolledAt + timeoutMs, tous deux transmis par le serveur), pas de duplication. Retourne `null`
// tant qu'aucun choix n'est en attente (pas de tick inutile).
