...
export function isDoorConnectorBlueprint(blueprint) {
  ...
  if (connectorType && connectorType !== 'door') return false
...
export function isElevatorConnectorBlueprint(blueprint) {
  return blueprint?.geometry?.connectorType === 'elevator'
}
